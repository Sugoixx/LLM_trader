...
class PositionExtractor:
    ...
    def __init__(self, logger: Optional[Logger] = None, unified_parser: "UnifiedParser" = None):
        ...
        self.rating_pattern: Pattern = re.compile(
    ...
    def extract_trading_info(self, text: str) -> Tuple[str, str, Optional[float], Optional[float], Optional[float], str, str]:
        ...
        Returns:
            Tuple of (signal, confidence, stop_loss, take_profit, position_size, reasoning, rating)
        """
    ...
    def _extract_from_dict(self, data: Dict[str, Any]) -> Tuple[str, str, Optional[float], Optional[float], Optional[float], str, str]:
        ...
        return signal, confidence, stop_loss, take_profit, position_size, reasoning, rating
    ...
    def _extract_from_text(self, text: str) -> Tuple[str, str, Optional[float], Optional[float], Optional[float], str, str]:
        ...
        rating = rating_match.group(1).upper() if rating_match else ""
