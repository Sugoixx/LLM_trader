...
function handleUpdate(data) {
    switch (data.type) {
        ...
        case 'analysis_complete':
            ...
            break;
        case 'auto_trade':
            document.dispatchEvent(new CustomEvent('auto-trade-update', { detail: data }));
            break;
        case 'algo_signals':
            document.dispatchEvent(new CustomEvent('algo-signals-update', { detail: data.data }));
            break;
        case 'fast_trading':
            document.dispatchEvent(new CustomEvent('fast-trading-update', { detail: data }));
            break;
        case 'fast_guard':
            document.dispatchEvent(new CustomEvent('fast-guard-update', { detail: data.data }));
            break;
        case 'capital_alert':
            document.dispatchEvent(new CustomEvent('capital-alert-update', { detail: data.data }));
            break;
        default:
